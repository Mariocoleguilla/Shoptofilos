...
<head>
    <title>Mis alquileres | Shoptófilos</title>
...
<body>
    ...
    <main>
        <div class="pageTitleContainer">
            <h1 class="pageTitle">Mis alquileres</h1>
        </div>
        <section class="container">
        <?php

        $sql = "SELECT j.titulo, j.plataforma, j.estudio, j.genero, a.fecha, a.id_ejemplar
                FROM juegos j, juegos_alquiler a, ejemplares e
                WHERE j.id_juego = e.id_juego
                AND e.id_ejemplar = a.id_ejemplar
                AND a.dni = \"" . $_SESSION['dni'] . "\" ORDER BY a.fecha";
        ...
        if ($result->num_rows > 0) {
            ...
            $warnings = "<p class=\"advice warning\">No has hecho ningún alquiler todavía<p>";
        }
        echo $warnings;
        ?>
        </section>
